        ...
        <div id='createPet' class='hidden'>
            ...
            <div class='card'>
                <table>
                    ...
                    <tr class='biTableSpacing'>
                        <td><b>Microchip: </b></td>
                        <td><input class='inputBox' id='microchip' placeholder='000000000000000'></td>
                    </tr>
                </table>
                <button id='add' class='cardButton'>
                    Add Pet
                </button>
                <button id='cancel' class='cardButton'>
                    Cancel
                </button>
            </div>
        </div>

        <button id='create' class='block'>
            Create Pet
        </button>
    </div>
    <div class='navbar'>
        <a>
            <button class='buttonActive'  aria-label='pet profile'>
