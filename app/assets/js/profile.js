document.addEventListener('DOMContentLoaded', () => {
    ...
    /**if ofline hide createButton and fill out patients, else keep createButton and fill out patients as well as
     *carry out xmlhttp requests
     */
    if (!navigator.onLine) {
        ...
        /**
         * @desc runs xmlhttp request to get all EMF information astore it in local storage
         * @param {integer} id 
         */
        function getEMF(id) {
            ...
            xhr.addEventListener('readystatechange', function() {
                if (xhr.readyState === XMLHttpRequest.DONE) {
                    try {
                        ...
                        localStorage.setItem('emr', JSON.stringify(emr));
         ...
         * request it forwards to a function to allows owner to select medical file, update, and delete 
         * for each pet profile. it also forwards to a function to save all EMF information
         */
        let xhr = new XMLHttpRequest();
        xhr.addEventListener('readystatechange', function() {
            profiles.innerHTML = '';
        ...
        /**
         * @desc allows for new pet to be added
         */
    ...
    /**
     * @desc sets up attributes for show button and emf button to avoid repeated code
     * @param {element} show 
     * @param {element} emf 
     * @param {element} card 
     */
    function makeShowandEMFBut(show, emf, card) {
    ...
    /**
     * @desc this function makes each patient card and fills it with their information. within this function
     * it also appends button to card depending on whether its online or offline.
     */
    function makePatients() {
        let stringPatients = localStorage.getItem('patients');
        ...
        keys.map(key => {
            ...
            //if navigator is online it will allow for update and delete functionality
            if (navigator.onLine) {
                ...
                card.append(del);
                makeShowandEMFBut(show, emf, card)
                ...
                /**
                 * @desc on click displays all information about the pet selected, and Displays an update button 
    ...
    /**
     * @desc this fills the EMF table with information stored from the xmlhttp request
     * @param {integer} id 
     * @param {element} emfTable 
     */
    function fillEMFTable(id, emfTable) {
        let stringEmr = localStorage.getItem('emr');
        let emr = JSON.parse(stringEmr);
